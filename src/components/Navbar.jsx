  ...
  return (
    <nav className="bg-white fixed w-full z-20 top-0 start-0 border-b border-gray-200">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <button type="button" class="text-black bg-white border-2 border-green-600 hover:text-white hover:bg-green-700 transition-colors duration-500 font-medium rounded-sm text-sm px-4 py-2 text-center">Get started</button>
          <button
