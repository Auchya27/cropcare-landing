...
import water from './assets/water-purifier.png'
...
<div className="App">
    ...
    <div className="relative overflow-hidden transition-transform duration-300 ease-in-out transform hover:scale-105">
      ...
      <section id="prize">
        ...
        <div className='m-7'>
        <h5 className="mb-2 mt-20 text-6xl font-bold tracking-tight text-gray-900 dark:text-gray-900 text-center">प्रत्येकास हमकास बक्षिस..!</h5>
        <p className="mt-5 font-normal text-gray-700 text-center text-3xl">नवीन संधी.. आता देईल उभारी..!</p>
        </div>
...
<div className="grid grid-cols-2 gap-2 mr-16 ml-16">
        ...
        <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
            <img className="h-auto max-w-full rounded-sm p-7 ml-20 mt-12" src={unicorn} alt="" />
            <p className="text-center text-2xl font-semibold">
            होंडा युनिकॉर्न
            </p>
        ...
        <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
            <img className="h-auto max-w-full rounded-sm p-7 ml-20" src={shine} alt="" />
        ...
        <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
            <img className="h-96 max-w-full rounded-sm p-7 ml-32" src={powert} alt="" />
...
<div className="grid grid-cols-2 md:grid-cols-4 gap-4 mr-16 ml-16 mt-20 mb-20">
    ...
    <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
        ...
        <span class="absolute top-0 left-0 m-2 rounded-full bg-red-500 px-3 py-1 text-center font-semibold text-white">02 विजेते</span>
    ...
    <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
        <img className="h-auto max-w-full rounded-sm" src={water} alt="" />
    ...
    <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
        <img className="h-72 max-w-full rounded-sm ml-10 mt-12" src={cooler} alt="" />
        <span class="absolute top-0 left-0 m-2 rounded-full bg-red-500 px-3 py-1 text-center font-semibold text-white">50 विजेते</span>
    ...
    <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
        <img className="h-52 max-w-full rounded-sm ml-10 mt-20" src={tools} alt="" />
    ...
    <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
        <img className="h-auto max-w-full rounded-sm mt-7" src={tv} alt="" />
        <span class="absolute top-0 left-0 m-2 rounded-full bg-red-500 px-3 py-1 text-center font-semibold text-white">10 विजेते</span>
    ...
    <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
        <img className="h-auto max-w-full rounded-sm mt-9" src={smartphone} alt="" />
    ...
    <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
        <img className="h-auto max-w-full rounded-sm ml-12 mt-12" src={stp} alt="" />
        <span class="absolute top-0 left-0 m-2 rounded-full bg-red-500 px-3 py-1 text-center font-semibold text-white">10 विजेते</span>
    ...
    <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
        <img className="h-auto max-w-full rounded-sm mt-2" src={khurpani} alt="" />
        <span class="absolute top-0 left-0 m-2 rounded-full bg-red-500 px-3 py-1 text-center font-semibold text-white">25 विजेते</span>
    ...
    <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
        <img className="h-64 max-w-full rounded-sm ml-20 mt-10" src={ata} alt="" />
    ...
    <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
        <img className="h-auto max-w-full rounded-sm mt-12" src={ranger} alt="" />
        <span class="absolute top-0 left-0 m-2 rounded-full bg-red-500 px-3 py-1 text-center font-semibold text-white">50 विजेते</span>
    ...
    <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
        <img className="h-auto max-w-full rounded-sm" src={kolpani} alt="" />
    ...
    <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
        <img className="h-auto max-w-full rounded-sm ml-12 mt-10" src={tarpaulin} alt="" />
    ...
    <div className='transition-transform duration-300 ease-in-out transform hover:scale-105'>
        <img className="h-auto max-w-full rounded-sm ml-6 mt-10" src={spray} alt="" />
      ...
      <section id="about">
        <>
       <div className='m-7'>
        <h5 className="mb-2 text-4xl font-bold tracking-tight text-gray-900 text-center">योजनेचे नियम, अटी व थोडक्यात माहिती</h5>
        <ol className="font-normal text-black text-xl leading-10 list-decimal mx-28 my-16">
