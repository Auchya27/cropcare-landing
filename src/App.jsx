      ...
      <section id="prize">
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mr-4 md:mr-16 ml-4 md:ml-16">
            ...
            <div className="transition-transform duration-300 ease-in-out transform hover:scale-105 grid place-content-center">
              <LazyLoadImage
                className="h-auto max-w-full rounded-sm p-7 mt-12"
                src={unicorn}
                alt=""
                effect="blur"
              />
            ...
            <div className="transition-transform duration-300 ease-in-out transform hover:scale-105 grid place-content-center">
              <LazyLoadImage
                className="md:h-96 max-w-full rounded-sm p-7"
                src={powert}
                alt=""
                effect="blur"
              />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mr-4 md:mr-16 ml-4 md:ml-16 mt-10 mb-10">
            ...
            <div className="transition-transform duration-300 ease-in-out transform hover:scale-105 grid place-content-center">
              <LazyLoadImage
                className="h-auto md:h-[76%] md:mt-5 rounded-sm"
                src={water}
                alt=""
                effect="blur"
              />
            ...
            <div className="transition-transform duration-300 ease-in-out transform hover:scale-105 grid place-content-center">
              <LazyLoadImage
                className="h-auto md:h-72 max-w-full rounded-sm mt-12"
                src={cooler}
                alt=""
                effect="blur"
              />
            ...
            <div className="transition-transform duration-300 ease-in-out transform hover:scale-105 grid place-content-center">
              <LazyLoadImage
                className="h-28 md:h-52 max-w-full rounded-sm mt-20"
                src={tools}
                alt=""
                effect="blur"
              />
            ...
            <div className="transition-transform duration-300 ease-in-out transform hover:scale-105 grid place-content-center">
              <LazyLoadImage
                className="h-auto max-w-full rounded-sm md:mt-7 mt-14"
                src={tv}
                alt=""
                effect="blur"
              />
            ...
            <div className="transition-transform duration-300 ease-in-out transform hover:scale-105 grid place-content-center">
              <LazyLoadImage
                className="h-auto max-w-full rounded-sm md:mt-9 mt-16"
                src={smartphone}
                alt=""
                effect="blur"
              />
            ...
            <div className="transition-transform duration-300 ease-in-out transform hover:scale-10 grid place-content-center">
              <LazyLoadImage
                className="h-32 md:h-auto max-w-full rounded-sm mt-12"
                src={stp}
                alt=""
                effect="blur"
              />
            ...
            <div className="transition-transform duration-300 ease-in-out transform hover:scale-105 grid place-content-center">
              <LazyLoadImage
                className="h-auto max-w-full rounded-sm md:mt-2 mt-6"
                src={khurpani}
                alt=""
                effect="blur"
              />
            ...
            <div className="transition-transform duration-300 ease-in-out transform hover:scale-105 grid place-content-center">
              <LazyLoadImage
                className="h-52 md:h-64 max-w-full rounded-sm mt-10"
                src={ata}
                alt=""
                effect="blur"
              />
            ...
            <div className="transition-transform duration-300 ease-in-out transform hover:scale-105 grid place-content-center">
              <LazyLoadImage
                className="h-auto max-w-full rounded-sm md:mt-12 mt-16"
                src={ranger}
                alt=""
                effect="blur"
              />
            ...
            <div className="transition-transform duration-300 ease-in-out transform hover:scale-105 grid place-content-center">
              <LazyLoadImage
                className="h-52 md:h-auto max-w-full rounded-sm"
                src={kolpani}
                alt=""
                effect="blur"
              />
            ...
            <div className="transition-transform duration-300 ease-in-out transform hover:scale-105 grid place-content-center">
              <LazyLoadImage
                className="h-auto max-w-full rounded-sm mt-10"
                src={tarpaulin}
                alt=""
                effect="blur"
              />
      ...
      <section id="about">
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:mr-8 sm:ml-8 mr-16 ml-16">
            <div>
              <LazyLoadImage
                className="h-auto max-w-full rounded-sm p-3 sm:p-7"
                src={sugar}
                alt="crop"
                effect="blur"
              />
            ...
            <div>
              <LazyLoadImage
                className="h-auto md:h-[80vh] max-w-full rounded-sm p-3 sm:p-7"
                src={other}
                alt="other"
                effect="blur"
              />
